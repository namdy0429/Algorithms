...
public class Main {
	static final String OUTPUT_PATH = "/Users/namdy/Documents/2015_FALL/ALGORITHM/hw1/BinaryTreeSum/input.txt";	// "c:\\hw1\\2012147504.txt";	// output file path
	private static PrintWriter fout;										// file Output objects
	
	static int depth = 15;
	static final int numberOfTree = 15;
